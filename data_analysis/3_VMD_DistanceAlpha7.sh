...
#SBATCH --ntasks=1
#SBATCH --mem=4G
#SBATCH --job-name=A7_VMD
#SBATCH --out=A7consoleoutput.out
#SBATCH --error=A7error.err
...
ml purge
ml vmd
vmd -dispdev text -e /uufs/chpc.utah.edu/common/home/bidone-group3/robert/1_HeadpieceTest/analysisScripts/Use/DistanceAlpha7_Ali_B-I.tcl > DistanceAlpha7_Ali_B-I.log
rm -v *#
			else
