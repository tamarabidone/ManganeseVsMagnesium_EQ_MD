...
#SBATCH --ntasks=1
#SBATCH --mem=4G
#SBATCH --job-name=M335_VMD
#SBATCH --out=M335consoleoutput.out
#SBATCH --error=M335error.err
...
ml purge
ml vmd
vmd -dispdev text -e /uufs/chpc.utah.edu/common/home/bidone-group3/robert/1_HeadpieceTest/analysisScripts/Use/DistanceMet335_Ali_B-I.tcl > DistanceMet335_Ali_B-I.log
rm -v *#
			else
